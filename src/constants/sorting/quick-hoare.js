...
export const quickhoare = createAlgorithmCard({
  ...
  homeCard: {
    ...
    difficulty: "Hard",
    description:
      "An efficient version of Quick Sort using the Hoare partition scheme, which typically involves fewer swaps than Lomuto.",
    complexity: {
      timeBest: "׸(n log n)",
      timeAvg: "׸(n log n)",
      timeWorst: "׸(n²)",
  ...
  algorithmPage: {
    ...
    extendedDescription:
      "Quick Sort with Hoare partition scheme uses two indices that start at the ends of the partition being analyzed, then move toward each other until they find an inversion: a pair of elements, one greater than or equal to the pivot, one less than or equal, that are in the wrong order relative to each other.",
    legendItems: [
