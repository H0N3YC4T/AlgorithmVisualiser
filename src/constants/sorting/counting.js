...
export const counting = createAlgorithmPage({
  id: "counting",
  ...
  algorithmPage: {
    ...
    extendedDescription:
      "Counting Sort is a non-comparative sorting algorithm that works by counting the number of objects having distinct key values.",
    legendItems: [
