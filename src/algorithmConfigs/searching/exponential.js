 ...
 */
export const exponentialsearch = createAlgorithmPage({
  ...
  metadata: {
    ...
    defaultInputs: { target: "3, 7, 11, 14, 19, 22, 26, 30, 35, 41, 47, 53", pattern: "47" },
  },
  ...
  algorithmPage: {
    ...
    extendedDescription:
      "Exponential Search starts by checking index 0. If not found, it repeatedly doubles the index (1, 2, 4, 8...) until it finds an element greater than the target or hits the end. Finally, it runs Binary Search on the range between the last two indices.",
    legendItems: [
      ...
      if (i < n && array[i] <= targetValue) {
        ...
        return {
          ...
          log: {
            ...
            params: { i, val: array[i], targetValue, nextI },
          },
        };
      }
    ...
    if (phase === 2) {
      ...
      return {
        ...
        log: {
          ...
          params: { l, r, mid: nextMid, val: array[nextMid] },
        },
      };
    }
      ...
      if (array[mid] < targetValue) {
        return {
          ...
          log: {
            ...
            params: { val: array[mid], targetValue, midPlusOne: mid + 1, r },
          },
        };
      }
      return {
        ...
        log: {
          ...
          params: { val: array[mid], targetValue, l, midMinusOne: mid - 1 },
        },
      };
    }
