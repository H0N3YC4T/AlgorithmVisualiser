 ...
 */
export const jumpsearch = createAlgorithmPage({
  id: "jumpsearch",
  ...
  metadata: {
    ...
    defaultInputs: { target: "3, 7, 11, 14, 19, 22, 26, 30, 35, 41, 47, 53", pattern: "30" },
  },
  ...
  algorithmPage: {
    ...
    extendedDescription:
      "Jump Search works on sorted arrays. It checks elements at fixed intervals (jumps) of size √n. Once it finds a block where the target might be, it performs a linear search within that block to find the exact position.",
    legendItems: [
