 ...
 */
export const linear = createAlgorithmPage({
  id: "linear",
  ...
  metadata: {
    ...
    defaultInputs: { target: "12, 5, 14, 8, 4, 11, 8, 15, 4, 6, 13, 10", pattern: "13" },
  },
  ...
  algorithmPage: {
    ...
    extendedDescription:
      "Linear Search is the simplest search algorithm. It traverses the array from the first element to the last, comparing each element with the target value until a match is found or the end of the array is reached.",
    legendItems: [
