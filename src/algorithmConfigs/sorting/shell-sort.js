...
export const shellsort = createAlgorithmPage({
  id: "shellsort",
  ...
  algorithmPage: {
    ...
    extendedDescription:
      "Shell Sort is a generalization of insertion sort that allows the exchange of items that are far apart. The distance between elements decreases until it becomes 1 (standard insertion sort).",
    legendItems: [
    ...
    if (phase === 2) {
      ...
      return {
        ...
        log: {
          ...
          type: "shift",
          messageKey: "GAP_SWAP",
          params: { valLeft: array[j - gap], valRight: array[j], gap },
        },
      };
    }
